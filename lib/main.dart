...
import 'TampilanPembatal.dart';
import 'TampilanRukun.dart';
import 'TampilanSunnah.dart';
import 'TampilanSyarat.dart';
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Stack(
                  children: <Widget>[
                    backgroundImage(
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIlXq8NSfeLMZuY0MLJXQ0NKWxfSiBocf8fGQtaYeiCzcM2lma&s"),
                    Align(
                      alignment: Alignment.bottomLeft,
                      child: Padding(
                        padding: const EdgeInsets.all(16.0),
